...
async def test_search_services(ds: spanner_gsql.Client):
...
async def test_search_kursus(ds: spanner_gsql.Client):
...
async def test_search_faqs(ds: spanner_gsql.Client):
